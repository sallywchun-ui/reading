...
PRACTICE_SENTENCES: List[Tuple[str, str, str]] = [
    ...
    # 以下取自《세종한국어 어휘·표현과 문법 1A》的真實例句
    ("초급", "책상 위에 책이 있어요.", "書桌上有書。"),
    ("초급", "저는 회사원이에요.", "我是上班族。"),
    ("초급", "전화번호가 뭐예요?", "電話號碼是幾號？"),
    ("초급", "지금 무엇을 해요?", "現在在做什麼？"),
    ("초급", "마트에 가요.", "我要去超市。"),
    ("초급", "빵하고 우유를 사요.", "買麵包和牛奶。"),
    ("초급", "몇 시에 시작해요?", "幾點開始？"),
    ("중급", "저녁 여섯 시에 친구 생일 파티에 가요.", "晚上六點要去朋友的生日派對。"),
    ("초급", "날씨가 어때요?", "天氣怎麼樣？"),
    ("초급", "김치가 매워요.", "泡菜很辣。"),
    ("초급", "가방이 무거워요.", "包包很重。"),
    ("중급", "어제 수영을 했어요?", "昨天游泳了嗎？"),
    ("중급", "친구하고 같이 김밥을 만들었어요.", "和朋友一起做了紫菜飯捲。"),
    ("중급", "내일 같이 영화를 볼까요?", "明天要不要一起看電影？"),
    ("초급", "여기에 앉을까요?", "要不要坐這裡？"),
]
